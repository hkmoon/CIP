...
public class FunctionParameters2 extends LinkedHashMap< String , DefaultParameter2> {
	...
	public static void main(final String... args)
	{
		...
		paramsHWS2.addRequired("inputImage", 	DefaultParameter2.Type.image );
		paramsHWS2.addOptional("threshold", 	DefaultParameter2.Type.scalar , 	null);
		paramsHWS2.addOptional("hMin", 			DefaultParameter2.Type.scalar , 	null);
		paramsHWS2.addOptional("PeakFlooding", 	DefaultParameter2.Type.scalar , 	100f );
		paramsHWS2.addOptional("Method", 		DefaultParameter2.Type.string , 	"gray");
